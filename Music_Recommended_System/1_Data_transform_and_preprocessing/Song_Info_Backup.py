...
@Time：2019/4/15 15:12
@Project:Music_Recommended_System
@Filename:Song_Info_Backup.py
"""


import cProfile as pickle

def parse_playlist_id_get_info(in_line,playlist_dic,song_dic):
...
def parse_file(in_file,out_playlist,out_song):
	...
	for line in open(in_file):
		parse_playlist_id_get_info(line,playlist_dic,song_dic)
	# 把映射字典保存在二进制文件中
