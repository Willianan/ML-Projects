...
@Project:NLP
@Filename:5_deep_learning_and_text_classifier.py
"""
...
def cnn_model(features, target):
	...
	with tf.variable_scope('CNN_Layer1'):
		...
		# 最大池化
		pool1 = tf.nn.max_pool(conv1, ksize=[1, POOLING_WINDOW, 1, 1], strides=[1, POOLING_STRIDE, 1, 1],
		                       padding='SAME')
		# 对矩阵进行转置，以满足形状
