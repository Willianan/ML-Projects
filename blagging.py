"""B(l)agging meta-estimator, modified to handle imbalanced distributions."""

# Based on bagging.py.
# Original Author: Gilles Louppe <g.louppe@gmail.com>
# License: BSD 3 clause
#
# Adaptations by Tom Fawcett <tfawcett@acm.org>, noted as TEF inline.
#
# NOTE: This is NOT an official file of sklearn.  It is based on
# sklearn.ensembles.bagging.py, written by Gilles Louppe and distributed under
...
# TEF made all of these absolute imports since this file shouldn't be in the
# sklearn tree:
...
def _parallel_build_balanced_estimators(n_estimators, ensemble, X, y,
                                        seeds, verbose):
...
class BlaggingClassifier(BaseBagging, ClassifierMixin):
	...
	def __init__(self,
		...
		# TEF: changed next call's arg to BlaggingClassifier
	...
	def _validate_estimator(self):
		...
		# TEF: changed next call's arg to BlaggingClassifier
		super(BlaggingClassifier, self)._validate_estimator(
...
class BlaggingRegressor(BaseBagging, RegressorMixin):
	"""A Bagging regressor.
	...
	def __init__(self,
	             ...
	             random_state=None,
	             verbose=0):
		raise NotImplementedError("BlaggingRegressor has not been implemented")
